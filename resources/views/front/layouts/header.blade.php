...
<body>
  <div class="w-full h-full mx-auto flex-col">
    ...
    <header class="header flex flex-col md:flex-row justify-center items-center md:items-start md:justify-between py-8 pl-0 md:pl-24 bg-white">
      ...
      <div id="social" class="social flex-none w-full md:w-[140px] align-right z-50">
        <div class="bg-[#BE1724] h-auto p-4 md:p-0 md:h-[273px] w-full md:w-[140px] absolute flex flex-row md:flex-col items-center justify-center my-0 md:-my-8">
          <div class="flex flex-row md:flex-col gap-8 social">
