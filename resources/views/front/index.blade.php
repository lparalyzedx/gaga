...
@section('content')
    ...
    <div class="flex flex-col md:flex-row items-start px-4 md:px-48 pt-24 pb-[523px] md:pb-[720px] gap-4 md:gap-48"
        ...
        <div class="z-50 bg-gradient-to-r from-[#BE1724] to-[#791119] p-16 mt-0 md:-mt-48 text-right rounded-2xl">
            ...
            <a href="{{route('company')}}" title="NEDEN GAGA" class="text-white font-semibold tracking-wider py-8 block">NEDEN
                GAGA</a>
            <a href="{{route('team')}}" title="EKİBİMİZ" class="text-white font-semibold tracking-wider block">EKİBİMİZ</a>
        </div>
    </div>
    ...
    <div class="flex flex-col md:flex-row px-4 md:px-48 pb-16 md:pb-80 gap-8 bg-[#242424]">
      ...
      <div
        ...
        <div class="mt-0 md:-mt-64 flex-1">
            ...
            <p class="text-white text-base font-semibold mt-12 mb-8 description">{{ strip_tags($news[0]->title  ?? 'S') }}</p>
        ...
        <div class="mt-0 md:-mt-64 w-full md:max-w-[50%]">
            ...
            <div class="flex items-center justify-between">
                <a class="text-white tracking-wider" href="{{route('news')}}" title="TÜMÜNÜ GÖRÜNTÜLE">TÜMÜNÜ GÖRÜNTÜLE</a>
                <ol class="flex">
                    <li><a href="javascript:;" title="" class="bg-[#BE1724] p-8 inline-block"><img class="owl-geri"
                                ...
                                alt=""></a></li>
                    <li><a href="javascript:;" title="" class="bg-[#BE1724] p-8 inline-block"><img
                                class="owl-ileri" src="{{ asset('front/images/icons/right-arrow.svg') }}" width="23"
                                height="36" alt=""></a></li>
                </ol>
            </div>
        </div>
    ...
    <div class="flex flex-col md:flex-row items-start px-4 md:px-48 py-4 md:py-24 gap-4 md:gap-48 bg-[#242424]">
        ...
        <div class="flex-1 relative mt-8 md:mt-0">
            ...
            <form action="" method="post">
                <input class="bg-transparent border-b border-[#868686] py-4 w-4/6" type="text"
                    placeholder="E-Posta@adresiniz.com" name="" id="">
            </form>
