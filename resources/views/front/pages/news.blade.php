        ...
        <a href="{{route('news.detail',$new->slug)}}">
            <div class="flex flex-col gap-4 group">
                <img src="{{asset('storage/news/'.$new->image)}}"
                    class="rounded-2xl hover:-mt-8 transition-all duration-500" style="width:400px !important; height: 300px !important; object-fit:cover;">
                <h3 class="text-2xl text-white group-hover:text-[#BE1724]">{{$new->title}}</h3>
